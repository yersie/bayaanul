...
public class GradeData {
    ...
    static final String TABLE_GRADE = "courses";
    static final String COLUMN_GRADE_ID = "course_id";
    static final String COLUMN_GRADE_NAME = "course_name";
    private static final String COLUMN_GRADE_FEE = "course_fee";
    private static final String COLUMN_GRADE_START_DATE = "course_start_date";
    private static final String COLUMN_GRADE_CLASSTIME = "course_end_date";
