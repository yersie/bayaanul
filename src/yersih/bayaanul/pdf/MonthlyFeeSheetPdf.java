...
public class MonthlyFeeSheetPdf {
    ...
    public void createPdf(List<Student> sL, String d, String m) throws IOException {
        ...
        PdfWriter writer = new PdfWriter(d);
        ...
        String[] columns = {"No.", "Index", "Name", "Phone", "Grades", "Total (RF)", m};
...
//                "July", "August", "September", "October", "November", "December"};
        ...
        document.add(new Paragraph(m + " " + LocalDate.now().format(DateTimeFormatter.ofPattern("yyyy")))
        ...
        sL.forEach(student -> addStudentRow(table, student, font));
        ...
        double sTotal = sL.stream().mapToDouble(Student::getStudentMonthly).sum();
    ...
    private static void addStudentRow(Table table, Student student, PdfFont font) {
