...
public class AttendanceData {
    ...
    public void addClassAttendance(Attendance attendance) throws SQLException {
    ...
    public void deleteStudentAttendances(String studentIndex) throws SQLException {
    ...
    public void deleteCourseAttendances(String courseId) throws SQLException {
    ...
    public void addAttendanceForNewEnrollment(Enrollment enrollment) throws SQLException {
